...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token="EoDp4XHbdX0r91qr8uzb.+i/EYC+vgrcMG1HqZG+0/W.H9sDu2/tvQWV7ECkDyIy4xdnOrm1+e0ScQRYTJHIufA=")
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token="EoCpXFmrZhynmDAoLiP7.J+E+ZpnsMtHxl4GccBIhPW.T6XhbcDbYDmQiuDK78eIlSOOEwLposkrOtLEZ//dDKA=")
km.loginResult()
...
╚═════════════════════════
"""
six="ubd47e33f0bfa9782cbde32e03e3e0707"
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"ubd47e33f0bfa9782cbde32e03e3e0707"]
